          ...
          >
            <span className="inline-flex">
              {yieldText.map((letter, index) => (
                <motion.span key={`yield-${index}`} variants={letterVariants} className="inline-block text-[#f9a826]">
                  {letter}
                </motion.span>
              ))}
            </span>
            <span className="inline-flex">
              {hive.map((letter, index) => (
                <motion.span key={`hive-${index}`} variants={letterVariants} className="inline-block text-[#1a2e44]">
                  {letter}
                </motion.span>
              ))}
            </span>
            <span className="inline-flex">
              {platform.map((letter, index) => (
                <motion.span
                  ...
                  className="inline-block text-[#4db6ac]"
                >
                  {letter}
                </motion.span>
              ))}
